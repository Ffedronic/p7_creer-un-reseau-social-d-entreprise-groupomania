...
exports.getComments = (req, res, next) => {
    ...
    const sqlGetComments = `SELECT comments.id AS id, comments.date AS date, comments.content AS content, users.firstName FROM comments JOIN users ON comments.author = users.id WHERE post = '${req.params.id}'`;
